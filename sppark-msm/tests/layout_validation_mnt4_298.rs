// MNT4-298 Layout Validation Tests
// Custom test harness (harness = false) to avoid Rust test framework CUDA cleanup conflicts
//
// Run with: cargo test --release --features gpu --test layout_validation_mnt4_298
...
fn call_msm(
    ...
    msm_mnt4_298_gpu_cgbn(points, scalars).map_err(|_| ())
}
...
fn main() {
    println!("╔═══════════════════════════════════════════════════════╗");
    println!("║  MNT4-298 Layout Validation Tests (Custom Harness)   ║");
    println!("╚═══════════════════════════════════════════════════════╝");
