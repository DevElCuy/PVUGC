// MNT4-298 CPU vs GPU Consistency Tests
...
// This is the critical validation needed before using MNT4-298 GPU MSM in production provers.
//
// Run with: cargo test --release --features gpu --test test_mnt4_cpu_gpu_consistency
...
fn main() {
    println!("========================================================");
    println!("  MNT4-298 CPU vs GPU Consistency Tests (CGBN Kernel)");
    println!("========================================================");
    ...
    if failed == 0 {
        println!("\n  ALL TESTS PASSED - MNT4-298 GPU matches CPU!");
