...
2. Confirm GPU support and curve coverage
   - Read `GPU_SUPPORT.md` for supported curves, feature flags, and env gating (`ENABLE_CGBN_STUB=1`).
...
6. Prioritized roadmap
   - Follow the ordered work list in `GPU_plan.md` and the matching summary in `GPU_SUPPORT.md`.
7. Run lean tests
